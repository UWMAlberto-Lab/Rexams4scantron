...
GradesOut<-cbind(eval$registration,ResTab)
names(GradesOut)<-c("registration",names(ResTab))
write.table(GradesOut,file="Results table.txt", sep="\t",row.names=F,quote=F)
```
